                      ...
                      <div className="ml-3">
                          ...
                          {e.confType === "live" &&
                            <>
                              ...
                              <div>
                                <h3 className="roboto" style={{ fontSize: "1vw", paddingLeft: "1vw", color: "#A9A9A9" }}><a rel="noreferrer noopener" target={"_blank"} href={`https://www.google.com/maps/search/${e.location.replace(" ", "+")}`}>{e.location}</a></h3>
                              </div>
                            </>}
                          {e.confType === "virtual" &&
                            <>
                              ...
                              <div>
                                <h3 style={{ fontSize: "0.7vw", paddingLeft: "1vw" }}><a rel="noreferrer noopener" target={"_blank"} href={e.location}>{e.location}</a> </h3>
                              </div>
                            </>}
                        </Row>
                      </div>
